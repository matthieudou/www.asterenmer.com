<template>
  <div class="relative min-h-screen ">
    <video
      class="absolute w-full h-full bg-video object-cover"
      autoplay
      loop
      muted
      :poster="require('~/assets/img/background.jpg')">
      <source
        v-if="$mq !== 'sm'"
    ...
    <div class="absolute inset-0 bg-blue-royal bg-opacity-50 flex flex-col">
      <div class="p-8">
        <img
